                    ...
                    <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                        ...
                        <Transition name="fade">
                            <div v-if="errorMessage"
                                class="mb-4 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-600 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400">
                                {{ errorMessage }}
                            </div>
                        </Transition>
                        ...
                        <form @submit.prevent="handleSubmit">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input v-model="email" type="email" placeholder="info@gmail.com"
                                ...
                                <div>
                                    <button type="submit" :disabled="loading"
                                        ...
                                        <!-- LOADING -->
                                        <svg v-if="loading" class="w-5 h-5 mr-2 animate-spin"
                    ...
                    <div class="flex items-center justify-center z-1">
                        ...
                        <div class="flex flex-col items-center max-w-xs">
                            <router-link to="/" class="block mb-4">
                                <img width="231" height="48" src="/images/logo/auth-logo.svg" />
                            </router-link>
...
import { useAuth } from '@/composables/useSignIn'
